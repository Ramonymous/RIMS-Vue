...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <!-- Header -->
            <Card
                class="overflow-hidden border-none bg-gradient-to-r from-primary/10 via-background to-background shadow-sm"
            >
                <CardContent
                    ...
                    <div class="flex flex-wrap gap-2">
                        <Badge variant="secondary" class="gap-2 px-3 py-1">
                            ...
                            <span class="text-emerald-600"
                                >({{ formatTrend(trend.incomingPct) }})</span
                            >
                        </Badge>
                        <Badge variant="secondary" class="gap-2 px-3 py-1">
                            ...
                            <span class="text-rose-600"
                                >({{ formatTrend(trend.outgoingPct) }})</span
                            >
                        </Badge>
                    </div>
                </CardContent>
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card
                    class="hover-lift border-l-4 border-l-blue-500 bg-card/80"
                >
                    <CardHeader
                    ...
                    >
                        ...
                        >
                        <div
                            class="rounded-full bg-blue-100 p-2 dark:bg-blue-950"
                        >
                            <Package
                ...
                <Card
                    class="hover-lift border-l-4 border-l-purple-500 bg-card/80"
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between space-y-0 pb-2"
                    >
                        <CardTitle class="text-sm font-medium"
                            >Total Stock</CardTitle
                        >
                        <div
                            class="rounded-full bg-purple-100 p-2 dark:bg-purple-950"
                        >
                            <BarChart3
                ...
                <Card
                    class="hover-lift border-l-4 border-l-orange-500 bg-card/80"
                >
                    <CardHeader
                        class="flex flex-row items-center justify-between space-y-0 pb-2"
                    >
                        ...
                        >
                        <div
                            class="rounded-full bg-orange-100 p-2 dark:bg-orange-950"
                        >
                            <AlertCircle
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card
                    class="hover-lift cursor-pointer border-l-4 border-l-green-500 bg-card/80"
                ...
                <Card
                    class="hover-lift cursor-pointer border-l-4 border-l-red-500 bg-card/80"
                ...
                <Card
                    class="hover-lift cursor-pointer bg-card/80"
            ...
            <Card class="shadow-md">
                <CardHeader
                    class="flex items-center gap-2 space-y-0 border-b bg-muted/30 py-5 sm:flex-row"
                >
                ...
                <CardContent class="px-2 pt-6 pb-6 sm:px-6">
                    <ChartContainer
                        :config="chartConfig"
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                ...
                <Card class="flex flex-col">
                    <CardHeader class="items-center border-b">
