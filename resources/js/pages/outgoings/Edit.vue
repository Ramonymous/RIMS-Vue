...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/outgoings/${props.outgoing.id}/edit` },
];

const form = useForm({
    doc_number: props.outgoing.doc_number,
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Update outgoing document details and items
                    </CardDescription>
                </CardHeader>
